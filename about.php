	      ...
	      <div class="container">
	        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
	          <div class="col-md-6 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
	            ...
	            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php">Inicio</a></span> <span>Martha Arias</span></p>
	          </div>
	        </div>
	      </div>
	    </div>
	    	...
	    	<div class="container">
	    		<div class="row d-flex">
	    			...
	    			<div class="col-md-6 pl-md-5 ftco-animate">
	    				<h2 class="mb-4">Welcome to Trim A Hair Salon Website</h2>
	    				<p> MARTHA ARIAS “Alto Estilismo Profesional” una sinaloense en Zacatecas, nacida en la hermosa ciudad de Mazatlán, con más de 20 años de experiencia profesional en la industria de la Belleza, con cursos y talleres de los laboratorios y empresas de cosméticas y alto peinado,</p>
	    				<p>  acreditada en PIVOT POINT en Cosmetología y Estética corporal, colorimetria y alto peinado, además de talleres y diplomados en Tec Italy, NBC, Paul Michel y Prabana </p>
	    			</div>
	    		</div>
	    	</div>
	    </section>
				...
				<div class="container">
					<div class="row justify-content-center" data-scrollax-parent="true">
						<div class="col-md-7 text-center discount ftco-animate" data-scrollax=" properties: { translateY: '-30%'}">
							<h3>Pregunta por nuestros descuentos y promociones</h3>
							<h2 class="mb-4">Mensuales</h2>
							<p class="mb-4"></p>
	    ...
	    <section class="ftco-section">
	      <div class="container">
	          ...
	          <div class="col-md-7 heading-section ftco-animate text-center">
	            ...
	            <p class="mt-5"> En Martha Arias contamos con un equipo de profesionistas altamente capacitados</p>
	          </div>
	        </div>
	        <div class="row">
	        	<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
	        		<div class="staff">
	      				...
	      				<div class="info text-center">
	      					...
	      					<div class="text">
		        				<p>Martha Arias, cuenta con más de 20 años de experiencia en la industria, cuenta con cursos y talleres de los laboratorios y escuelas de alto peinado, acreditada en PIVOT POINT en Cosmetología y Estética corporal, colorimetria y alto peinado, además de talleres y diplomados en Tec Italy, NBC, Paul Michel y Prabana. </p>
		        			</div>
	      				</div>
	        		</div>
	        	</div>
	        	<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
	        		<div class="staff">
	      				...
	      				<div class="info text-center">
	      					<h3><a href="teacher-single.html">Martha Arias</a></h3>
	      					<span class="position"> Técnica en uñas </span>
	      					<div class="text">
