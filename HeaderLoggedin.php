    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="about.php" class="nav-link">Martha Arias</a></li>
                ...
                <li class="nav-item"><a href="cotizacion.php" class="nav-link">Cotizar</a></li>
